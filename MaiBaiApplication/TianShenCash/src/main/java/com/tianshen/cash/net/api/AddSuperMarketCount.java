...
public class AddSuperMarketCount extends NetBase {
    private String mUrl;
    private Context mContext;
    private JSONObject mJSONObject;

    public AddSuperMarketCount(Context context) {
        super(context);
        mContext = context;
        mUrl = NetConstantValue.addFlowSupermarketClickCountURL();
    }

    public void addSuperMarketCount(JSONObject jsonObject, View view, boolean isShowDialog, final BaseNetCallBack<PostDataBean> callBack) {
