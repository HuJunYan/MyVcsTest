 ...
 */
public class ChangeContactsInfo extends NetBase {
    private boolean isRelease = true;
    private String mUrl;
    private Context mContext;
    private JSONObject mJSONObject;

    public ChangeContactsInfo(Context context) {
        super(context);
        mContext = context;
        mUrl = NetConstantValue.getChangeContactsInfoURL();
    }

    public void changeContactsInfo(JSONObject jsonObject, final BaseNetCallBack<ResponseBean> mResponseCallBack) {
        try {
    ...
    public void changeContactsInfo(JSONObject jsonObject, View view, boolean isShowDialog, final BaseNetCallBack<ResponseBean> mResponseCallBack) {
        try {
            mJSONObject = SignUtils.signJsonNotContainList(jsonObject);
            if (mJSONObject == null) {
                return;
    ...
    private ResponseBean test() {
        ...
        mResponseBean.setMsg("ChangeContactsInfo in success");
