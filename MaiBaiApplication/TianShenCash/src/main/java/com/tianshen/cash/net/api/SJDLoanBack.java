...
public class SJDLoanBack extends NetBase {
    private boolean isRelease = true;
    private String mUrl;
    private Context mContext;
    private JSONObject mJSONObject;

    public SJDLoanBack(Context context) {
        super(context);
        mContext = context;
        mUrl = NetConstantValue.getSJDLoanBackUrl();
    }

    public void sjdLoanBack(JSONObject jsonObject, final BaseNetCallBack<PostDataBean> callBack) {
        try {
