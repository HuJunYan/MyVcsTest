...
public class SaveExtroContacts extends NetBase {
    private String mUrl;
    private Context mContext;
    private JSONObject mJSONObject;

    public SaveExtroContacts(Context context) {
        super(context);
        mContext = context;
        mUrl = NetConstantValue.getSaveExtroContactsUrl();
    }

    public void saveExtroContacts(JSONObject jsonObject, final BaseNetCallBack<PostDataBean> callBack) {
        try {
            mJSONObject = SignUtils.signJsonContainList(jsonObject, "data");
            if (mJSONObject == null) {
                return;
            }
