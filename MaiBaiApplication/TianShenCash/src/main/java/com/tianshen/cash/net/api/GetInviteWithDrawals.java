...
public class GetInviteWithDrawals extends NetBase {
    private String mUrl;
    private Context mContext;
    private JSONObject mJSONObject;

    public GetInviteWithDrawals(Context context) {
        super(context);
        mContext = context;
        mUrl = NetConstantValue.getInviteWithDrawalsUrl();
    }

    public void inviteWithDrawals(JSONObject jsonObject, View view, boolean isShowDialog, final BaseNetCallBack<PostDataBean> callBack) {
