...
public class GetVerifySmsForConfirmLoan extends NetBase {

    private String mUrl;
    private Context mContext;
    private JSONObject mJSONObject;

    public GetVerifySmsForConfirmLoan(Context context) {
        super(context);
        mContext = context;
        mUrl = NetConstantValue.getVerifySmsForConfirmLoanUrl();
    }

    public void getVerifySmsForConfirmLoan(JSONObject jsonObject, View view, boolean isShowDialog, final BaseNetCallBack<PostDataBean> callBack) {
