...
public class MyTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void findViews(View rootView) {
        ...
        view_bottom_line = rootView.findViewById(R.id.view_bottom_line);
    }
    ...
    public MyTextView setBottomLineVisibility(int visibility) {
        view_bottom_line.setVisibility(visibility);
        return this;
    }
