...
public class SubmitVerifyCode extends NetBase {

    private String mUrl;
    private Context mContext;
    private JSONObject mJSONObject;

    public SubmitVerifyCode(Context context) {
        super(context);
        mContext = context;
        mUrl = NetConstantValue.getSubmitVerifyCodeUrl();
    }

    public void verifyCode(JSONObject jsonObject, View view, boolean isShowDialog, final BaseNetCallBack<PostDataBean> callBack) {
