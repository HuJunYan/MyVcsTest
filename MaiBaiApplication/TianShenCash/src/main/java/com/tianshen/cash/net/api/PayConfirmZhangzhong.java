...
public class PayConfirmZhangzhong extends NetBase {
    ...
    public PayConfirmZhangzhong(Context context) {
        super(context);
        mUrl = NetConstantValue.getPayConfirmZhangzhongUrl();
    }

    public void payConfirm(JSONObject jsonObject, View view, boolean isShowDialog, final BaseNetCallBack<PostDataBean> callBack) {
