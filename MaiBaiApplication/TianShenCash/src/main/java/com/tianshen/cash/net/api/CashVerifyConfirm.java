 ...
 */
public class CashVerifyConfirm extends NetBase {
    private boolean isRelease = true;
    private String mUrl;
    private Context mContext;
    private JSONObject mJSONObject;

    public CashVerifyConfirm(Context context) {
        super(context);
        mContext = context;
        mUrl = NetConstantValue.getCashVerifyConfirmURL();
    }

    public void cashVerifyConfirm(JSONObject jsonObject, final BaseNetCallBack<ResponseBean> mResponseCallBack) {
        try {
    ...
    public void cashVerifyConfirm(JSONObject jsonObject, View view, boolean isShowDialog, final BaseNetCallBack<ResponseBean> mResponseCallBack) {
        try {
            mJSONObject = SignUtils.signJsonNotContainList(jsonObject);
            if (mJSONObject == null) {
                return;
    ...
    private ResponseBean test() {
        ...
        mResponseBean.setMsg("CashVerifyConfirm in success");
