...
public class ShareUtils {
    ...
    private static final String SHARE_TITLE = "买呗";
    private static final String SHARE_DESCRIPTION = "现在用买呗，可用500-10000信用额度";
    private static final String SHARE_WEBURL = "http://123.56.252.169/Public/Download/index.html";
    private static final String SHARE_BACK = "返回买呗";
...
//        params.putString(QQShare.SHARE_TO_QQ_TITLE, "买呗");//标题
//        params.putString(QQShare.SHARE_TO_QQ_APP_NAME,  "返回买呗");
        params.putInt(QQShare.SHARE_TO_QQ_EXT_INT, QQShare.SHARE_TO_QQ_FLAG_QZONE_ITEM_HIDE);
