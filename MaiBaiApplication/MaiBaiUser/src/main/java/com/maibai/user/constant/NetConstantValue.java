...
public class NetConstantValue {
   // release
//    public static String COMMONURI = "http://api.9maibei.com/Home/";
    ...
    public static boolean getService(){
        if(COMMONURI.equals("http://182.92.10.40/Home/")){
            return true;
        }
        if(COMMONURI.equals("http://123.56.252.169/Home/")){
            return false;
        }
        return false;
    }
    ...
    /**
     * 分期付款下单
     * api: com.maibei.merchants.net.api.OrderInstallmentRepay.orderInstallmentRepay()
     *
     * @return
     */
    public static String getOrderInstallmentRepayUrl() {
        return COMMONURI + "Order/orderInstallmentRepay";
    }

    /**
     * 次月还款下单
     * api: com.maibei.merchants.net.api.OrderNextMonthRepay.orderNextMonthRepay()
     *
     * @return
     */
    public static String getOrderNextMonthRepayUrl() {
        return COMMONURI + "Order/orderNextMonthRepay";
    }

    /**
     * 商户列表 (附近商户列表)
     * api: com.maibei.merchants.net.api.GetNearByList.getNearByList()
     *
     * @return
     */
    public static String getNearByListUrl() {
        return COMMONURI + "Merchant/getNearbyList";
    }
...
//    }
    ...
    /**
     * 转为分期还款（计算分期）
     * api: com.maibei.merchants.net.api.CalculateInstallment.calculateInstallment()
     *
     * @return
     */
    public static String GetCalculateInstallmentUrl() {
        return COMMONURI + "UserCenter/calculateInstallment";
    }

    /**
     * 转为分期还款（确定转为分期）
     * api: com.maibei.merchants.net.api.ChangeToInstallment.changeToInstallment()
     *
     * @return
     */
    public static String GetChangeToInstallmentUrl() {
        return COMMONURI + "UserCenter/changeToInstallment";
    }
    ...
    /**
     * 取认证证书上传状态
     * api: com.maibei.merchants.net.api.GetCertUploadStatus.getCertUploadStatus()
     *
     * @return
     */
    public static String GetCertUploadStatusUrl() {
        return COMMONURI + "UserCenter/getCertUploadStatus";
    }
    ...
    /**
     * 首次激活额度
     * api: com.maibei.merchants.net.api.ActiveQuota.activeQuota()
     *
     * @return
     */
    public static String getActiveQuota() {
        return COMMONURI + "Credit/enableCredit";
    }
    ...
    /**
     * 提高额度
     * api: com.maibei.merchants.net.api.ImproveCredit.improveCredit()
     *
     * @return
     */
    public static String getImproveCreditUrl() {
        return COMMONURI + "Credit/improveCredit";
    }
    ...
    * */
    ...
    /*
    * 获取商家类型列表
    *api:com.maibei.user.net.api.GetMerchantTypeList.getMerchantTypeList()
    * */
    public static String getMerchantTypeListURL(){
        return COMMONURI+"System/getMerchantTypeList";
    }

    /*
    * 用户付款记录
    *api:com.maibei.user.net.api.GetConsumeList.getConsumeList()
    * */
    public static String getConsumeListURL(){
        return COMMONURI+"UserCenter/getConsumeList";
    }

    /*
    * 下单查询
    *api:com.maibei.user.net.api.OrderQuery.getOrderRealPay()
    * */
    public static String getOrderRealPayURL(){
        return COMMONURI+"Order/orderQuery";
    }

    /*
    * 待审核订单刷新
    *api:com.maibei.user.net.api.GetOrderRefresh.getOrderRefresh()
    * */
    public static String getOrderRefreshURL(){
        return COMMONURI+"Order/orderRefresh";
    }

    /*
    * 预订单金额计算
    *api:com.maibei.user.net.api.GetPreOrderAmount.getPreOrderAmount()
    * */
    public static String getPreOrderAmountURL(){
        return COMMONURI+"Order/preOrderAmount";
    }

    /*
    * 取消订单
    *api:com.maibei.user.net.api.OrderCancel.orderCancel()
    * */
    public static String getOrderCancelURL(){
        return COMMONURI+"Order/orderCancel";
    }
    ...
    * */
    public static String getConsumeBigBillListURL(){
        return COMMONURI+"UserCenter/getConsumeBigBillList";
    }
    ...
    * */
    public static String getConsumeSmallBillListURL(){
        return COMMONURI+"UserCenter/getConsumeSmallBillList";
    }
