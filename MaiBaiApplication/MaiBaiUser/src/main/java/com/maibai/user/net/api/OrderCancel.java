...
/**
 * Created by m on 16-9-23.
 */
public class OrderCancel extends NetBase {
    private boolean isRelease = true;
    private String mUrl;
    private Context mContext;
    private JSONObject mJSONObject;

    public OrderCancel(Context context) {
        super(context);
        mContext = context;
        mUrl = NetConstantValue.getOrderCancelURL();
    }

    public void orderCancel(JSONObject jsonObject, final BaseNetCallBack<ResponseBean> mResponseCallBack) {
        try {
    ...
    public void orderCancel(JSONObject jsonObject, View view, boolean isShowDialog, final BaseNetCallBack<ResponseBean> mResponseCallBack) {
        try {
            mJSONObject = SignUtils.signJsonNotContainList(jsonObject);
            if (mJSONObject == null) {
                return;
    ...
    private ResponseBean test() {
        ...
        mResponseBean.setMsg("OrderCancel in success");
