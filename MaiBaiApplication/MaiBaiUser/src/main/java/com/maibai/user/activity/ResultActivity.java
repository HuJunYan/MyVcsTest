...
import com.maibai.user.model.ImageVerifyRequestBean;
import com.maibai.user.model.ResponseBean;
import com.maibai.user.model.UploadImageBean;
import com.maibai.user.net.api.CreditFace;
import com.maibai.user.net.api.IDCardAction;
import com.maibai.user.net.api.SaveIdCardInformation;
import com.maibai.user.net.api.UploadImage;
...
import com.maibai.user.utils.TimeCount;
    ...
    private void saveIdCardInformation() {
        ...
        mSaveIdCardInformationAction.saveIdCardInformation(json, new BaseNetCallBack<ResponseBean>() {
            ...
            public void onSuccess(ResponseBean paramT) {
                ...
                ToastUtil.showToast(ResultActivity.this, "请进行人脸识别");
                livenessNetWorkWarranty();
...
//                                    gotoLiveness();
    ...
    private void selectLivenessControl(String name,String idCardNum){
        ...
        if(2<=scanTime&&scanTime<5){
            ...
            UserUtil.setReason(mContext,"您不符合我们的征信条件");
    ...
    private void showScanErrorDialog(String name,String idCardNum){
     /*   Dialog dialog=new Dialog(mContext);
        ...
        dialog.setTitle("请确认您的信息，如信息有误，请联系买呗客服");
        View view= LayoutInflater.from(mContext).inflate(R.layout.id_and_name_layout,null);
        TextView tv_name=(TextView)view.findViewById(R.id.tv_name);
        TextView tv_card_num=(TextView)view.findViewById(R.id.tv_card_num);
        tv_name.setText(name);
        tv_card_num.setText(idCardNum);
...
*/
        ...
        builder.setMessage("请确认您的信息，若信息有误，请联系买呗\n姓名："+name+"\n"+"身份证号："+idCardNum);
