...
import com.maibai.user.model.CustomerAuthBean;
import com.maibai.user.model.GetBankListBean;
import com.maibai.user.net.api.GetAuthListStatus;
import com.maibai.user.net.api.GetBindBankList;
import com.maibai.user.net.api.GetCustomerAuth;
import com.maibai.user.net.base.AuthenticationBean;
import com.maibai.user.net.base.AuthenticationStatus;
...
public class ImproveQuotaActivity extends BaseActivity implements View.OnClickListener ,TitleBar.TitleBarListener{
    ...
    public void updateView(ImageTextView view, String isAuthentication) {
        if (GlobalParams.ALREADY_AUTHENTICATION.equals(isAuthentication)||GlobalParams.ALREDY_AUTHENTICATION_BY_TOOLS.equals(isAuthentication)) {
