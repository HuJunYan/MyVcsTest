package com.maibai.user.constant;
...
public class GlobalParams {
	...
	public static final int APPLY_TYPE_GET_CASH = 4; //提取现金
	...
	public static final String ALREDY_AUTHENTICATION_BY_TOOLS="3";//小工具认证
	...
	public static final String HAVE_UPLOAD_CONTACTS_INFO="1";//已经上传过联系人信息
	public static final String HAVE_UPLOAD_IDCARD_INFO="2";//已上传身份信息
	public static final String HAVE_SCAN_FACE="3";//已扫脸通过
...
//	public static final int MONEY_LEVER_4TH = 200000; // 单位：分
	...
	public static final String LAST_UPDATE_NEAR_SHOP_LIST_TIME = "last_update_near_shop_list_time";

	// 广播相关的key值
	public static final String PASS_CALL_RECORD_ACTION = "pass_call_record_action";  // 通话记录没有获取到时，放行广播
	public static final String PASS_CONTACT_ACTION = "pass_contact_action";  // 通讯录没有获取到时，放行广播
	public static final String VERIFY_FINISHED_ACTION = "verify_finished_action";  // 接收到审核完成的push时，放行广播
	public static final String REFRESH_HOME_PAGE_ACTION="order_success_success_action";//通知首页刷新
	public static final String VERIFY_SUCCESS_ACTION="verify_success_actioin";//审核成功，用于提高额度
	public static final String REMOVEBIND_SUCCESS_ACTION="removebind_success_action";//解除绑定银行卡成功
	public static final String WECHAT_PAY_SUCCESS_ACTION="wx_pay_success";//微信付款成功
	public static final String ACTIVE_SUCCESS_ACTION="active_success";//激活成功
	public static final String BIND_CARD_SUCCESS_ACTION="bind_card_success_action";//绑定银行卡成功
	public static final String LOGIN_SUCCESS_ACTION="login_success_action";//登陆成功
	public static final String WITHDRAWALS_VERIFY_FINISHED_ACTION="withdrawals_verify_finished_action";//提现审核完成广播
	public static final String WITHDRAWALS_ORDER_SUCCESS_ACTION="withdrals_order_success_action";//提现下单完成
	public static final String REPAY_WITHDRAWAL_SUCCESS_ACTION="repay_withdrawal_success_action";//现金贷还款
	public static final String LOT_OF_VERIFY_STATUE_ACTION="lot_of_verify_status_action";//各种审核状态完成的推送

	public static final String LOGOUT_ACTION="logout_action";//退出账号
	public static enum AuthenticType {
		INPUT_BY_HAND,
		SCAN_ID_CARD,
		LIVENESS
	}
	...
	// 现金贷审核状态
	public static final String CASH_APPLY_WAIT_VERIFY = "10"; // 现金贷申请待审核
	...
	public static final String SHOUFU_BROAD_ACTION="wx_shoufu_success";//首付成功广播内容

	public static final String JPUSH_ID_KEY = "jpush_id_key"; // 存到sp中的jpushId的键值

	public static final String WX_REPAY_CONSUMPTION_SUCCESS_ACTION="wx_repay_success";//微信还消费成功
	public static final String WX_REPAY_BORROW_SUCCESS_ACTION="wx_repay_borrow_success_action";//微信还现金贷成功
	public static final String WX_REPAY_BORROW_DETAIL_SUCCESS_ACTION="wx_repay_borrow_detail_success_action";//微信还现金贷详情成功
	...
	public static final String APPLY_TYPE_KEY = "apply_type_key"; // 提交申请的类型，APPLY_TYPE_IMPROVE:提额,APPLY_TYPE_INSTALLMENT:分期,APPLY_TYPE_WITHDRAWALS:提现申请,APPLY_TYPE_GET_CASH:提取现金
	public static final String WITHDRAWALS_VERIFY_ID_KEY = "withdrawals_verify_id_key"; // 体现申请订单待审核时的id
	...
	public static final String REPAY_FROM_CONSUMPTION="repay_from_consumption";//消费还款
	...
	public static final String REPAY_BEAN_TOTAL_DATA_KEY="repay_bean_total_data_key";//提现详情页进入还款页面时带入提现详情的所有数据的key
	public static final String REPAY_FROM_BORROW_DETAIL="repay_from_borrow_detail";//从提现账单详情进入
