...
public class UserUtil {
    ...
    * */
    ...
    public static String getReason(Context context) {
        return SharedPreferencesUtil.getInstance(context).getString("reason");
    }
     ...
     * @param reason
     */
    public static void setReason(Context context, String reason) {
        SharedPreferencesUtil.getInstance(context).putString("reason", reason);
    }
    ...
    public static void setUser(Context context, SignInBean signIn) {
        ...
        String mm = signIn.getData().getCustomer().getCredit_step();
        ...
        if(!TextUtils.isEmpty(signIn.getData().getCredit().getStatus())){
            setStatus(context, signIn.getData().getCredit().getStatus());
        }
        if(!TextUtils.isEmpty(signIn.getData().getCredit().getReason())){
            setReason(context, signIn.getData().getCredit().getReason());
        }
