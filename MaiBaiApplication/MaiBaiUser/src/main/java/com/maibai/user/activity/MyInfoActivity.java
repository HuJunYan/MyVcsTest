...
import com.maibai.user.model.ContactsInfoBean;
import com.maibai.user.model.ResponseBean;
import com.maibai.user.net.api.ChangeContactsInfo;
import com.maibai.user.net.api.GetContactsInfo;
...
public class MyInfoActivity extends BaseActivity implements View.OnClickListener, TitleBar.TitleBarListener {
    ...
    private String formatText(String content, int start, int end, int xingNum) {
        ...
        if (content==null && "".equals(content) || (content.length() <= end)) {
            return content;
        } else {
    ...
    private String formatLongText(String content, int lenth) {
        if (content==null || "".equals(content) || content.length() <= lenth) {
            return content;
        } else {
