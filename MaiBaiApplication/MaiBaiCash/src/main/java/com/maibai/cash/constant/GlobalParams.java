package com.maibai.cash.constant;
...
public class GlobalParams {
	...
	public static final int ADD_BORROW_TERM=6;//各种审核状态
...
//	public static final int MONEY_LEVER_4TH = 200000; // 单位：分
	...
	public static final String REFRESH_HOME_PAGE_ACTION="qtq_order_success_success_action";//通知首页刷新
