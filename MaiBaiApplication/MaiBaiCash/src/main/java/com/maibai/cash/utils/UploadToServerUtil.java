...
import com.maibai.cash.model.ContactsBean;
import com.maibai.cash.model.LastSaveCallRecordTimeBean;
import com.maibai.cash.model.RecordEntityBean;
import com.maibai.cash.model.ResponseBean;
import com.maibai.cash.model.SMSMessageBean;
import com.maibai.cash.model.SaveCallRecordBean;
import com.maibai.cash.net.api.GetLastSaveCallRecordTime;
import com.maibai.cash.net.api.SaveCallRecord;
import com.maibai.cash.net.api.SaveContacts;
...
public class UploadToServerUtil {
    ...
    public void uploadCallContacts(){
        ...
        if (list.size() == 0) {
            new PermissionUtils(mContext).showPermissionDialog(1);
            return;
        }
