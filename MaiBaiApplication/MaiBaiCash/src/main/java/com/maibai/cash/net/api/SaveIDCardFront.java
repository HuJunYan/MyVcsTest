...
public class SaveIDCardFront extends NetBase {
    private String mUrl;
    private Context mContext;
    private JSONObject mJSONObject;

    public SaveIDCardFront(Context context) {
        super(context);
        mContext = context;
        mUrl = NetConstantValue.getSaveFrontIdCardInfoUrl();
    }

    public void saveIDCardFront(JSONObject jsonObject, final BaseNetCallBack<PostDataBean> callBack) {
        try {
