...
public class SignUp extends NetBase {
    ...
    public void signUp(JSONObject jsonObject, final BaseNetCallBack<ResponseBean> mResponseCallBack) {
        try {
    ...
    public void signUp(JSONObject jsonObject, View view, boolean isShowDialog, final BaseNetCallBack<ResponseBean> mResponseCallBack) {
        try {
            jsonObject.put("password", Utils.MD5SHA1AndReverse(jsonObject.getString("password")));
            mJSONObject = SignUtils.signJSONbject(jsonObject);
            if (mJSONObject == null) {
    ...
    private ResponseBean test() {
        ...
        mResponseBean.setMsg("signUp success");
