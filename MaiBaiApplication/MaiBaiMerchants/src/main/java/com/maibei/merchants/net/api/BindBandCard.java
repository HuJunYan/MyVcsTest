 ...
 */
public class BindBandCard extends NetBase {
    private boolean isRelease = true;
    private String mUrl;
    private Context mContext;
    private JSONObject mJSONObject;

    public BindBandCard(Context context) {
        super(context);
        mContext = context;
        mUrl = NetConstantValue.getBindBandCardUrl();
    }

    public void bindBandCard(JSONObject jsonObject, final BaseNetCallBack<ResponseBean> mResponseCallBack) {
        try {
    ...
    public void bindBandCard(JSONObject jsonObject, View view, boolean isShowDialog, final BaseNetCallBack<ResponseBean> mResponseCallBack) {
        try {
            mJSONObject = SignUtils.signJSONbject(jsonObject);
            if (mJSONObject == null) {
                return;
    ...
    private ResponseBean test() {
        ...
        mResponseBean.setMsg("bindBandCard success");
