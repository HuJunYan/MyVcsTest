 ...
 */
public class BankCardEditText extends LinearLayout implements View.OnFocusChangeListener, View.OnClickListener {
    ...
    public BankCardEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        rootView = LayoutInflater.from(context).inflate(R.layout.view_bank_edit_text, this);
        findViews(rootView);
        init(attrs);
    }
