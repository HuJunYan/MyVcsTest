...
//            Log.d("result-------------------", ""+result);
    ...
    public static void ChangeReadWritePermission (String path) {
		String partShellCommand = "chmod 777 " + path;
		String allShellCommand[] = { "shell", partShellCommand };
		CommandResult execResult = ShellUtils.execCommand(allShellCommand, false);
