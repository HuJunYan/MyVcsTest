 ...
 */
public class LoginEditText extends LinearLayout implements View.OnFocusChangeListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.iv_right:
                if(hide){
                    hide=false;
                    et_content.setTransformationMethod(HideReturnsTransformationMethod.getInstance());
                }
                else{
                    hide=true;
                    et_content.setTransformationMethod(PasswordTransformationMethod.getInstance());
