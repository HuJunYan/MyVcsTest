 ...
 */
public class GetMerchantBankList extends NetBase {
    private boolean isRelease = true;
    private String mUrl;
    private Context mContext;
    private JSONObject mJSONObject;
    public GetMerchantBankList(Context context) {
        super(context);
        mContext = context;
        mUrl = NetConstantValue.GetMerchantBankListUrl();
    }

    public void getMerchantBankList(JSONObject jsonObject, final BaseNetCallBack<BankListBean> mBankListCallBack) {
        try {
    ...
    public void getMerchantBankList(JSONObject jsonObject, View view, boolean isShowDialog, final BaseNetCallBack<BankListBean> mBankListCallBack) {
        try {
            mJSONObject = SignUtils.signJSONbject(jsonObject);
            if (mJSONObject == null) {
                return;
