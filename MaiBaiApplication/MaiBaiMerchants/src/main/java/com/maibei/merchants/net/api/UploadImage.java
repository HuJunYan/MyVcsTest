...
import com.maibei.merchants.net.base.NetCheck;
import com.maibei.merchants.net.base.XUtilsManager;
...
public class UploadImage {
    ...
    public void uploadImage(JSONObject jsonObject, String fileFullPath,boolean isShowDialog, final int type, final BaseNetCallBack<UploadImageBean> mUploadImageCallBack) {
