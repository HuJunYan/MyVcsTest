...
package com.maibei.merchants.qrcodescan.camera;
...
public final class CameraManager {
	...
	/*
	 * private static final int MIN_FRAME_WIDTH = 400; private static final int
	 * MIN_FRAME_HEIGHT = 400; private static final int MAX_FRAME_WIDTH = 900;
	...
	public static void init(Context context) {
		if (cameraManager == null) {
			...
			SharedPreferencesUtil.getInstance(context).putBoolean(GlobalParams.IS_CAMERA_INITED, true);
		}
	}
